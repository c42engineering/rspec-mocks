...
module RSpec
  module Mocks
    describe "#any_instance" do
      class CustomErrorForAnyInstanceSpec < StandardError;
      end

      let(:klass) do
        Class.new do
          def existing_method;
            :existing_method_return_value;
          end

          def existing_method_with_arguments(arg_one, arg_two = nil)
            ; :existing_method_with_arguments_return_value;
          end
      ...
      context "with #stub" do
        ...
        context "behaves as 'every instance'" do
          ...
          it "stubs all instances created by dup" do
        ...
        context "core ruby objects" do
          ...
          it "works with the non-standard constructor module" do
            ...
            module RSpec::SampleRspecTestModule
              ;
            end
          ...
          it "works with the non-standard constructor class" do
            ...
            class RSpec::SampleRspecTestClass;
            end
